...
namespace Modules\CustomerAd\Http\Controllers;
...
//        }
        ...
        return view('customerad::index', $data);
    }
...
//        }
        ...
        return view('customerad::create', $data);
    }
    ...
    {
        echo json_encode(Brand::where('category_id', $cat_id)->get());
    }


    public function getModels($brand_id)
    {
        echo json_encode(BrandModel::where('brand_id', $brand_id)->get());
    }
...
//        }
        ...
        if ($image) {
            ...
            Storage::putFileAs("listnbuy/public/images", $image, $fileName);

            $url = Storage::url("listnbuy/public/images/" . $fileName);
        ...
        return redirect()->route('frontend.customerad.index');
    }
    ...
    public function show(Ad $ad)
    {
        ...
        return view('customerad::show', compact('ad'));
    }
    ...
    public function edit(Ad $ad)
    {
        ...
        return view('customerad::edit', compact('ad'), $data);
    }
...
//        }
        ...
        return redirect()->route('module.customerad.index');
    }
