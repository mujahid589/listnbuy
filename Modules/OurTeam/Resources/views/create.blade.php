            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title" style="line-height: 36px;">Create Team Member</h3>
                    ...
                    <div class="row pt-3 pb-4">
                        <div class="col-md-8 offset-md-2">
                            <form class="form-horizontal" action="{{ route('module.ourteam.store') }}" method="POST"
                                ...
                                <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <select required name="type" id="ad_category" class="form-control @error('type') border-danger @enderror">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <select required name="order" id="ad_category" class="form-control @error('order') border-danger @enderror">
                                            @for ($i=0;$i<20;$i++)
                                                <option {{ old('order') == $i ? 'selected':'' }} value="{{ $i }}">{{ $i }}</option>
                                            @endfor
