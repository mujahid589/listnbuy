...
class ApiMessangerController extends Controller
{
    ...
    function getMessagesUserList() {
        ...
        $data['other_users'] = $users->where('id', '!=', Auth::user()->id);
        return response()->json($data);
    }

    // get messages list with selected user
    function getMessagesList(Request $request) {
        $request->validate([
            'username' => 'required'
        ]);
