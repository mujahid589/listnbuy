...
return [
    ...
    */
    ...
    'from' => [
        'address' =>array_key_exists('MAIL_FROM_ADDRESS', $_SERVER) ? $_SERVER['MAIL_FROM_ADDRESS'] : env('MAIL_FROM_ADDRESS') ,
        'name' =>array_key_exists('MAIL_FROM_NAME', $_SERVER) ? $_SERVER['MAIL_FROM_NAME'] : env('MAIL_FROM_NAME'),
    ],
