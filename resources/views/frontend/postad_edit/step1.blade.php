...
@section('post-ad-content')
    ...
    <div class="tab-pane fade show active" id="pills-basic" role="tabpanel" aria-labelledby="pills-basic-tab">
        <div class="dashboard-post__information step-information">
            ...
            @endif
            <form id="step1_edit_form" action="{{ route('frontend.post.update',$ad->slug) }}" method="POST" novalidate >
                @csrf
                @method('PUT')
                <div class="dashboard-post__information-form">
                    ...
                    <div class="input-field__group">
                        <div class="input-field">
                            ...
                            <input value="{{ $ad->title }}" name="title" type="text" placeholder="{{ __('website.ad_name') }}" id="adname"  class="@error('title') border-danger @enderror"/>
                        </div>
                        <div class="input-field">
                            <label for="price">{{ __('website.price') }}<span class="text-danger">*</span></label>
                            <input value="{{ $ad->price ?? '' }}" name="price" type="number" min="1" placeholder="Price" id="price"  class="@error('price') border-danger @enderror"/>
                        </div>
                    </div>
                    ...
                    <div class="input-field__group">
                        ...
                        <div class="input-field">
                            ...
                            <input value="{{ $ad->model ?? '' }}" name="model" type="text" placeholder="Model" id="modell" class="@error('model') border-danger @enderror" />
                        </div>
                    </div>
