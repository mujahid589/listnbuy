        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12 align-content-lg-center justify-content-lg-center">
                    <h2 class="text--display-3 banner__title animate__animated animate__bounceInDown">{{ __('website.banner_header') }} Category</h2>
                                        ...
                                        <a href="{{ route('frontend.adlist.category.show', $category->slug) }}" class="second view-btn">
                                            ...
                                            <div class="caticonbox">
                                                <div class="topcaticon">
                                                    <i class="{{ $category->icon }}" style="font-size: 24px;color: #fff"></i>
                                                </div>

                                                    <p class="" style="color: #fff;font-size:12px">{{ $category->name }}
