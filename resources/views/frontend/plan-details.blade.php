...
<section class="section benefits bgcolor--gray-10">
    <div class="container">
        ...
        <div class="row">
            ...
            {{-- Stripe payment  --}}
            @if ($payment_setting->stripe &&(array_key_exists('STRIPE_KEY', $_SERVER) ? $_SERVER['STRIPE_KEY'] : env('STRIPE_KEY')) && (array_key_exists('STRIPE_SECRET', $_SERVER) ? $_SERVER['STRIPE_SECRET'] : env('STRIPE_SECRET')))
            <div class="col-xl-6">
                <div class="membership-card">
                    <div class="membership-card__icon" style="background-color: #e8f7ff">
                        <x-svg.stripe-icon />
