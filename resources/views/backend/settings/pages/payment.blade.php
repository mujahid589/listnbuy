            ...
            <div class="card-body">
                <form class="form-horizontal" action="{{ route('admin.stripesetting') }}" method="POST"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input value="{{ array_key_exists('STRIPE_KEY', $_SERVER) ? $_SERVER['STRIPE_KEY'] : env('STRIPE_KEY')}}" name="stripe_client_id" type="text"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input value="{{array_key_exists('STRIPE_SECRET', $_SERVER) ? $_SERVER['STRIPE_SECRET'] : env('STRIPE_SECRET') }}" name="stripe_client_secret" type="text"
