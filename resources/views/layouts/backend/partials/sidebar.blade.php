...
{{--                    @if (Module::collections()->has('Testimonial') && userCan('ourteam.view') &&--}}
{{--                    $testimonial_enable)--}}
                    <ul class="nav nav-treeview">
                        <x-sidebar-list
                            :linkActive="Route::is('module.ourteam.index') || Route::is('module.ourteam.create') || Route::is('module.ourteam.edit') ? true : false"
                            route="module.ourteam.index" icon="fas fa-circle">
                            Teams
                        </x-sidebar-list>
                    </ul>
{{--                    @endif--}}
